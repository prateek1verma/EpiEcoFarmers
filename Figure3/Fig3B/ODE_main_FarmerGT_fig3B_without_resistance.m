...
% f_vec = [0.05, 0.25, 0.4, 0.65] % Figure 3A
f_vec = [0.1, 0.33, 0.4, 0.65]; % Figure 3B
...
beta_w = 0.01;  % Transmission rate of the wildtype strain
beta_r = 0.01;  % Transmission rate of the resistant strain
mu =  5;        % Natural death rate of the host population
eps_w = 0.7;    % Efficacy of the fungicide on the wild-type strain
eps_r = 0.6;    % Efficacy of the fungicide on the resistant strain
...
init_freq_resist = 0.0;     % proportion of resitant infection out of total initial infection
...
title('$R_0<1/(1-\epsilon_w)$','interpreter','latex',FontSize=22) % title
set(gca,'FontSize',20)
...
line([0.714 0.714],[-0.1 1.1],'LineWidth',3,'Color',[0.8 0.8 0.8]);
legend('$f=0.10$','$f=0.33$','$f=0.40$','$f=0.65$','$\theta_c = 0.714$','Location','southwest','interpreter','latex',FontSize=18)
