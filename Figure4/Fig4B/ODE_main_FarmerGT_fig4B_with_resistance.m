...
% f_vec = [0.05, 0.15, 0.25, 0.5]; % Figure 4A
f_vec = [0.05, 0.25, 0.5, 0.65]; % Figure 4B
...
eps_r = 0.8;    % Efficacy of the fungicide on the resistant strain
...
line([0.94 0.94],[-0.1 1.1],'LineWidth',3,'Color',[0.8 0.8 0.8]);
legend('$f=0.05$','$f=0.25$','$f=0.50$','$f=0.65$','$\theta_{max} = 0.94$','Location','southwest','interpreter','latex',FontSize=18)
