...
f_vec = [0.05, 0.425, 0.55, 0.75]; % Figure B2-A
...
title('$\epsilon_r>\epsilon_{rc}, \gamma=0.3$','interpreter','latex',FontSize=22) % title
set(gca,'FontSize',20)
...
legend('$f=0.05$','$f=0.425$','$f=0.55$','$f=0.75$','Location','southwest','interpreter','latex',FontSize=18)
print('FigS2B.eps','-depsc')